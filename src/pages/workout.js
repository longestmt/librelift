  ...
  container.innerHTML = `
    <div class="flex items-center justify-between" style="margin-bottom:var(--sp-4)">
      ...
      <div class="flex items-center gap-2">
        <button id="workout-clock" class="btn btn-ghost font-mono text-sm text-accent" style="min-width:50px;padding:var(--sp-2) var(--sp-3)" title="Tap to pause/resume" aria-label="Pause or resume workout">0:00</button>
