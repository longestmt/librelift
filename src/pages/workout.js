...
function renderSetRow(set, si, ei, exName = '') {
  ...
  const exContext = exName ? ` of ${escapeHTML(exName)}` : '';
  return `<div class="set-row">
    <span class="set-number" aria-hidden="true">${set.setNumber}</span>
    <input class="input-inline ${lockedCls}" type="number" aria-label="Weight for set ${set.setNumber}${exContext}" value="${set.weight}" data-ei="${ei}" data-si="${si}" data-field="weight" inputmode="decimal" ${locked}/>
    <input class="input-inline ${lockedCls}" type="number" aria-label="Reps for set ${set.setNumber}${exContext}" value="${set.reps}" data-ei="${ei}" data-si="${si}" data-field="reps" inputmode="numeric" ${locked}/>
    <input class="input-inline ${lockedCls}" type="number" aria-label="RPE for set ${set.setNumber}${exContext}" value="${set.rpe || ''}" data-ei="${ei}" data-si="${si}" data-field="rpe" inputmode="decimal" placeholder="—" ${locked}/>
    <button class="set-check ${cls}" aria-label="Mark set ${set.setNumber}${exContext} complete" aria-pressed="${isPressed}" data-ei="${ei}" data-si="${si}">${icon}</button>
  </div>`;
}
