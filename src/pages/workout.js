  ...
  container.innerHTML = `
    <div class="flex items-center justify-between" style="margin-bottom:var(--sp-4)">
      ...
      <div class="flex items-center gap-2">
        <button id="workout-clock" class="btn btn-ghost font-mono text-sm text-accent" style="min-width:50px;padding:var(--sp-2) var(--sp-3)" title="Tap to pause or resume" aria-label="Workout timer, tap to pause or resume">0:00</button>
    ...
    return `<div class="card" data-ei="${ei}">
      <div class="card-header" style="cursor:pointer" data-toggle="${ei}">
        ...
        <div class="flex items-center gap-1">
          <button class="btn btn-ghost btn-icon" data-show-history="${ei}" title="History" aria-label="View history for ${ex.exerciseName}" style="width:32px;height:32px"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg></button>
          <button class="btn btn-ghost btn-icon" data-swap-ex="${ei}" title="Swap exercise" aria-label="Swap ${ex.exerciseName} with another exercise" style="width:32px;height:32px"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M7 16V4m0 0L3 8m4-4l4 4"/><path d="M17 8v12m0 0l4-4m-4 4l-4-4"/></svg></button>
          <button class="btn btn-ghost btn-icon" data-show-plates="${ei}" title="Plates" aria-label="Calculate plates for ${ex.exerciseName}" style="width:32px;height:32px"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="2" y="6" width="4" height="12" rx="1"/><rect x="18" y="6" width="4" height="12" rx="1"/><line x1="6" y1="12" x2="18" y2="12"/></svg></button>
        </div>
      </div>
