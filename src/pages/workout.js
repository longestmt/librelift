    ...
    planList.innerHTML = plans.map(p => {
      ...
      return `<div class="card" style="cursor:pointer" data-plan-id="${p.id}">
        <div class="card-header">
          <div><div class="card-title">${escapeHTML(p.name)}</div><div class="text-xs text-muted" style="margin-top:2px">Up next: ${day ? escapeHTML(day.name) : 'Workout'}</div></div>
