    ...
    return `
        <div>
          <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:var(--sp-2)">
            ...
            <button class="btn btn-ghost btn-icon" data-start-day="${di}" aria-label="Start day ${escapeHTML(day.name)}" title="Start ${escapeHTML(day.name)}" style="width:32px;height:32px;color:var(--accent)">
