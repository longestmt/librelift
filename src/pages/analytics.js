...
export async function renderAnalyticsPage(container) {
    ...
    <div class="page-header">
      <h1 class="page-title">Analytics <span class="badge badge-accent" style="font-size:var(--text-xs);vertical-align:middle">Beta</span></h1>
      <p class="page-subtitle">Track your progress and performance</p>
    </div>
