...
export function createTimerElement() {
    ...
    <div class="rest-timer-content">
      ...
      <div class="rest-timer-actions">
        <button class="rest-timer-btn" data-timer-action="skip" aria-label="Skip timer" title="Skip">
          <svg aria-hidden="true" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polygon points="5 4 15 12 5 20 5 4"/><line x1="19" y1="5" x2="19" y2="19"/></svg>
        </button>
      </div>
    </div>`;
