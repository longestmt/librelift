        ...
        days: [
            {
                ...
                exercises: [
                    { exerciseName: 'Barbell Deadlift', sets: 1, reps: 5, increment: 10, incrementUnit: 'lb', deloadPercent: 10, deloadAfter: 2 },
                    { exerciseName: 'Lat Pulldown', sets: 3, reps: 8, repsMax: 12, increment: 5, incrementUnit: 'lb', deloadPercent: 10, deloadAfter: 3 },
                    { exerciseName: 'Seated Cable Row', sets: 3, reps: 8, repsMax: 12, increment: 5, incrementUnit: 'lb', deloadPercent: 10, deloadAfter: 3 },
                    { exerciseName: 'Face Pull', sets: 5, reps: 15, repsMax: 20, increment: 0, incrementUnit: 'lb', deloadPercent: 0, deloadAfter: 0 },
                    { exerciseName: 'Hammer Curl', sets: 4, reps: 8, repsMax: 12, increment: 5, incrementUnit: 'lb', deloadPercent: 10, deloadAfter: 3 },
                    { exerciseName: 'Dumbbell Curl', sets: 4, reps: 8, repsMax: 12, increment: 5, incrementUnit: 'lb', deloadPercent: 10, deloadAfter: 3 },
                ],
            },
            {
                name: 'Push A (Bench)',
                exercises: [
                    { exerciseName: 'Barbell Bench Press', sets: 5, reps: 5, increment: 5, incrementUnit: 'lb', deloadPercent: 10, deloadAfter: 3 },
                    { exerciseName: 'Overhead Press', sets: 3, reps: 8, repsMax: 12, increment: 5, incrementUnit: 'lb', deloadPercent: 10, deloadAfter: 3 },
                    { exerciseName: 'Incline Dumbbell Bench Press', sets: 3, reps: 8, repsMax: 12, increment: 5, incrementUnit: 'lb', deloadPercent: 10, deloadAfter: 3 },
                    { exerciseName: 'Tricep Pushdown', sets: 3, reps: 8, repsMax: 12, increment: 5, incrementUnit: 'lb', deloadPercent: 10, deloadAfter: 3 },
                    { exerciseName: 'Lateral Raise', sets: 3, reps: 15, repsMax: 20, increment: 0, incrementUnit: 'lb', deloadPercent: 0, deloadAfter: 0 },
                    { exerciseName: 'Overhead Tricep Extension', sets: 3, reps: 8, repsMax: 12, increment: 5, incrementUnit: 'lb', deloadPercent: 10, deloadAfter: 3 },
                    { exerciseName: 'Lateral Raise', sets: 3, reps: 15, repsMax: 20, increment: 0, incrementUnit: 'lb', deloadPercent: 0, deloadAfter: 0 },
                ],
            },
            {
                ...
                exercises: [
                    ...
                    { exerciseName: 'Romanian Deadlift', sets: 3, reps: 8, repsMax: 12, increment: 5, incrementUnit: 'lb', deloadPercent: 10, deloadAfter: 3 },
                    { exerciseName: 'Leg Press', sets: 3, reps: 8, repsMax: 12, increment: 10, incrementUnit: 'lb', deloadPercent: 10, deloadAfter: 3 },
                    { exerciseName: 'Leg Curl', sets: 3, reps: 8, repsMax: 12, increment: 5, incrementUnit: 'lb', deloadPercent: 10, deloadAfter: 3 },
                    { exerciseName: 'Standing Calf Raise', sets: 5, reps: 8, repsMax: 12, increment: 5, incrementUnit: 'lb', deloadPercent: 10, deloadAfter: 3 },
                ],
            },
            {
                name: 'Pull B (Row)',
                exercises: [
                    { exerciseName: 'Barbell Row', sets: 5, reps: 5, increment: 5, incrementUnit: 'lb', deloadPercent: 10, deloadAfter: 3 },
                    { exerciseName: 'Pull-Up', sets: 3, reps: 8, repsMax: 12, increment: 0, incrementUnit: 'lb', deloadPercent: 0, deloadAfter: 0 },
                    { exerciseName: 'Seated Cable Row', sets: 3, reps: 8, repsMax: 12, increment: 5, incrementUnit: 'lb', deloadPercent: 10, deloadAfter: 3 },
                    { exerciseName: 'Face Pull', sets: 5, reps: 15, repsMax: 20, increment: 0, incrementUnit: 'lb', deloadPercent: 0, deloadAfter: 0 },
                    { exerciseName: 'Hammer Curl', sets: 4, reps: 8, repsMax: 12, increment: 5, incrementUnit: 'lb', deloadPercent: 10, deloadAfter: 3 },
                    { exerciseName: 'Dumbbell Curl', sets: 4, reps: 8, repsMax: 12, increment: 5, incrementUnit: 'lb', deloadPercent: 10, deloadAfter: 3 },
            ...
            },
            {
                ...
                exercises: [
                    { exerciseName: 'Overhead Press', sets: 5, reps: 5, increment: 5, incrementUnit: 'lb', deloadPercent: 10, deloadAfter: 3 },
                    { exerciseName: 'Barbell Bench Press', sets: 3, reps: 8, repsMax: 12, increment: 5, incrementUnit: 'lb', deloadPercent: 10, deloadAfter: 3 },
                    { exerciseName: 'Incline Dumbbell Bench Press', sets: 3, reps: 8, repsMax: 12, increment: 5, incrementUnit: 'lb', deloadPercent: 10, deloadAfter: 3 },
                    { exerciseName: 'Tricep Pushdown', sets: 3, reps: 8, repsMax: 12, increment: 5, incrementUnit: 'lb', deloadPercent: 10, deloadAfter: 3 },
                    { exerciseName: 'Lateral Raise', sets: 3, reps: 15, repsMax: 20, increment: 0, incrementUnit: 'lb', deloadPercent: 0, deloadAfter: 0 },
                    { exerciseName: 'Overhead Tricep Extension', sets: 3, reps: 8, repsMax: 12, increment: 5, incrementUnit: 'lb', deloadPercent: 10, deloadAfter: 3 },
