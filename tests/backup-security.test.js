    ...
    const source = {
        ...
        stores: {
            ...
            settings: [
                ...
                { key: 'webdavLastBackup', value: '2026-09-01T12:00:00Z' },
                { key: 'exercisesSeeded', value: true },
                { key: 'cardioSeedVersion', value: 1 },
                { key: 'libreliftIdentityMigrationVersion', value: 1 },
                { key: 'lastUsedPlanId', value: 'local-plan' },
                { key: 'libresyncDeviceId', value: 'device-secret-sentinel' },
                { key: 'libresyncDeviceLabel', value: 'Tyler phone' },
                { key: 'libresyncConsent', value: true },
                { key: 'libresyncServerUrl', value: 'https://sync.example.test' },
                { key: 'futureProviderCredential', value: 'unknown-secret' },
